            ...
            <div>
              ...
              <div className="mt-2">
                <input
                  ...
                  required
                  autoComplete="email"
                  className="block w-full bg-gray-200 rounded-md px-3 py-1.5 text-base text-black outline-1 -outline-offset-1  placeholder:text-gray-500 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-500 sm:text-sm/6"
                />
              </div>
            </div>
